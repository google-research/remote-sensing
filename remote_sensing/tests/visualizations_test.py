...
class VisualizationsTest(parameterized.TestCase):
  ...
  def test_visualize_segmentation(self, use_weights: bool, golden_file: str):
    ...
    image_file = resource / "models/testdata/test_image.png"
    ...
    # int64[B, H, W]
    label_file = resource / "models/testdata/test_segmentation_label.png"
    ...
    # int64[B, H, W]
    pred_file = resource / "models/testdata/test_segmentation_prediction.png"
    ...
    # float32[B, 1, H, W]
    if use_weights:
      weight_file = resource / "models/testdata/test_segmentation_weight.png"
  ...
  def test_visualize_dataset_predictions(self):
    ...
    golden_file = (
        resource / "models/testdata/test_object_detection_golden.png"
    )
    golden = cv2.imread(golden_file, cv2.IMREAD_COLOR)  # uint8[H', W', BGR]
    golden = cv2.cvtColor(golden, cv2.COLOR_BGR2RGB)  # uint8[H', W', RGB]
